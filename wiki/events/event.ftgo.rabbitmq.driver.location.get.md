---
id: event.ftgo.rabbitmq.driver.location.get
kind: Event
type: Event
title: driver.location.get
status: approved
...
- Broker identity: `driver.location.get`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.driver.location.get`

## Consumers

- `service.ftgo.location` `CONSUMES` -> `event.ftgo.rabbitmq.driver.location.get`
