---
id: event.ftgo.rabbitmq.delivery.rating.get-customer-ratings
kind: Event
type: Event
title: delivery.rating.get_customer_ratings
status: approved
...
- type: PUBLISHES
  ...
  evidence_type: implemented
attributes:
  identity: delivery.rating.get_customer_ratings
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
# delivery.rating.get_customer_ratings
...
- Broker identity: `delivery.rating.get_customer_ratings`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.delivery.rating.get-customer-ratings`

## Consumers

- `service.ftgo.feedback` `CONSUMES` -> `event.ftgo.rabbitmq.delivery.rating.get-customer-ratings`
