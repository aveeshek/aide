---
id: event.ftgo.rabbitmq.driver.vehicle.delete
kind: Event
type: Event
title: driver.vehicle.delete
status: approved
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: driver.vehicle.delete
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `driver.vehicle.delete`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.driver.vehicle.delete`

## Consumers

- `service.ftgo.user` `CONSUMES` -> `event.ftgo.rabbitmq.driver.vehicle.delete`
