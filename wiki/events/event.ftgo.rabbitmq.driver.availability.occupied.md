---
id: event.ftgo.rabbitmq.driver.availability.occupied
kind: Event
type: Event
title: driver.availability.occupied
status: approved
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: driver.availability.occupied
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `driver.availability.occupied`
- Correlation: `consumer_only`
- Mechanism: `rpc`
...
- `service.ftgo.location` `CONSUMES` -> `event.ftgo.rabbitmq.driver.availability.occupied`
