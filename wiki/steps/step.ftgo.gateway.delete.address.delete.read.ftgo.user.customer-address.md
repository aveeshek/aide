---
id: step.ftgo.gateway.delete.address.delete.read.ftgo.user.customer-address
kind: FlowStep
type: FlowStep
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.delete.address.delete.consume.user.user.address.delete
...
- `application.address.AddressService.delete_address` -> `domain.manager.UserManager.load` (`backend/microservices/user/src/application/address.py:39`)
