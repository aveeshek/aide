---
id: step.ftgo.gateway.post.address.set-preferred.consume.user.user.address.set-preferred-address
kind: FlowStep
type: FlowStep
title: user consumes user.address.set_preferred_address
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.address.set-preferred.publish.ftgo.rabbitmq.user.address.set-preferred-address
...
attributes:
  ...
  handler_expression: AddressService.set_preferred_address
  handler_symbol: application.address.AddressService.set_preferred_address
  operation: register_event
---

# user consumes user.address.set_preferred_address
