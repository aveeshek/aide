---
id: step.ftgo.gateway.delete.profile.delete.publish.ftgo.rabbitmq.user.profile.delete-account
kind: FlowStep
type: FlowStep
title: publish user.profile.delete_account
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.delete.profile.delete.dispatch.services.user.userservice.delete-account
...
# publish user.profile.delete_account
...
- Declared in: `backend/gateway/src/services/user.py` (lines 39-39)
