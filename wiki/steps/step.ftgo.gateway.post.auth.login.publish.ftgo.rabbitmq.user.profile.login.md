---
id: step.ftgo.gateway.post.auth.login.publish.ftgo.rabbitmq.user.profile.login
kind: FlowStep
type: FlowStep
title: publish user.profile.login
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.auth.login.dispatch.services.user.userservice.login
...
- Declared in: `backend/gateway/src/services/user.py` (lines 31-31)
