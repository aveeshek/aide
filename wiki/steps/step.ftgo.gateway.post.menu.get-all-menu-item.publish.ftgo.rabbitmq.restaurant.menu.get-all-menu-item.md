---
id: step.ftgo.gateway.post.menu.get-all-menu-item.publish.ftgo.rabbitmq.restaurant.menu.get-all-menu-item
kind: FlowStep
type: FlowStep
title: publish restaurant.menu.get_all_menu_item
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.menu.get-all-menu-item.dispatch.services.menu.menuservice.get-all-menu-item
...
# publish restaurant.menu.get_all_menu_item
...
- Declared in: `backend/gateway/src/services/menu.py` (lines 27-27)
