---
id: step.ftgo.gateway.post.restaurant.register.publish.ftgo.rabbitmq.restaurant.supplier.register
kind: FlowStep
type: FlowStep
title: publish restaurant.supplier.register
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.restaurant.register.dispatch.services.restaurant.restaurantservice.register
...
# publish restaurant.supplier.register
...
- Declared in: `backend/gateway/src/services/restaurant.py` (lines 11-11)
