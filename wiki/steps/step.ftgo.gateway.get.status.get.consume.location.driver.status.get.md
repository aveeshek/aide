---
id: step.ftgo.gateway.get.status.get.consume.location.driver.status.get
kind: FlowStep
type: FlowStep
title: location consumes driver.status.get
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.status.get.publish.ftgo.rabbitmq.driver.status.get
...
attributes:
  ...
  handler_expression: DriverService.get_driver_status
  handler_symbol: application.driver.DriverService.get_driver_status
  operation: register_event
---

# location consumes driver.status.get
