---
id: step.ftgo.gateway.delete.address.delete.consume.user.user.address.delete
kind: FlowStep
type: FlowStep
title: user consumes user.address.delete
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.delete.address.delete.publish.ftgo.rabbitmq.user.address.delete
...
attributes:
  ...
  handler_expression: AddressService.delete_address
  handler_symbol: application.address.AddressService.delete_address
  operation: register_event
---

# user consumes user.address.delete
