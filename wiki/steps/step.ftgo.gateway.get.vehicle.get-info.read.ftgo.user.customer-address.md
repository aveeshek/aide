---
id: step.ftgo.gateway.get.vehicle.get-info.read.ftgo.user.customer-address
kind: FlowStep
type: FlowStep
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.vehicle.get-info.consume.user.driver.vehicle.get-info
...
- `application.vehicle.VehicleService.get_vehicle_info` -> `domain.manager.UserManager.load` (`backend/microservices/user/src/application/vehicle.py:17`)
