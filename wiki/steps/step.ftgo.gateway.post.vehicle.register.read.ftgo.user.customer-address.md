---
id: step.ftgo.gateway.post.vehicle.register.read.ftgo.user.customer-address
kind: FlowStep
type: FlowStep
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.vehicle.register.consume.user.driver.vehicle.register
...
- `application.vehicle.VehicleService.register_vehicle` -> `domain.manager.UserManager.load` (`backend/microservices/user/src/application/vehicle.py:8`)
