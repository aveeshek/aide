---
id: step.ftgo.gateway.get.restaurant.get-all-restaurant-info.consume.restaurant.restaurant.supplier.get-all-restaurant-info
kind: FlowStep
type: FlowStep
title: restaurant consumes restaurant.supplier.get_all_restaurant_info
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.restaurant.get-all-restaurant-info.publish.ftgo.rabbitmq.restaurant.supplier.get-all-restaurant-info
...
attributes:
  ...
  handler_expression: RestaurantService.get_all_restaurant_info
  handler_symbol: application.supplier.RestaurantService.get_all_restaurant_info
  operation: register_event
---

# restaurant consumes restaurant.supplier.get_all_restaurant_info
