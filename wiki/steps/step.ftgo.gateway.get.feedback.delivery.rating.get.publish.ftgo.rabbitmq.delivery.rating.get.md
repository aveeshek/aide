---
id: step.ftgo.gateway.get.feedback.delivery.rating.get.publish.ftgo.rabbitmq.delivery.rating.get
kind: FlowStep
type: FlowStep
title: publish delivery.rating.get
status: approved
...
derived_from: event.ftgo.rabbitmq.delivery.rating.get
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.feedback.delivery.rating.get.dispatch.services.feedback.feedbackservice.get-delivery-rating
  ...
  evidence_type: implemented
attributes:
  event_identity: delivery.rating.get
  operation: call
  mechanism: rpc
...
- Anchored on: `event.ftgo.rabbitmq.delivery.rating.get` (`Event`)
