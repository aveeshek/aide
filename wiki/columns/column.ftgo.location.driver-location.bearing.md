---
id: column.ftgo.location.driver-location.bearing
kind: Column
type: Column
title: bearing
status: approved
...
- Declared in: `backend/microservices/location/src/data_access/models/driver_location.py` (lines 21-21)
