---
id: column.ftgo.restaurant.supplier-profile.postal-code
kind: Column
type: Column
title: postal_code
status: approved
...
- Declared in: `backend/microservices/restaurant/src/models/supplier.py` (lines 16-16)
