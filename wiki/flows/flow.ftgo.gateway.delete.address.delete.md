---
id: flow.ftgo.gateway.delete.address.delete
kind: UserFlow
type: UserFlow
title: DELETE /address/delete execution flow
status: approved
...
entry_endpoint: endpoint.ftgo.gateway.delete.address.delete
http_method: DELETE
path: /address/delete
...
- service.ftgo.user
events:
- event.ftgo.rabbitmq.user.address.delete
persistence_targets:
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.delete.address.delete.http-ingress
  role: http_ingress
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/gateway/src/application/routes/customer/address.py
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.delete.address.delete.read.ftgo.user.customer-address
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.delete.address.delete.read.ftgo.user.user-profile
  role: persistence_read
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.delete.address.delete.read.ftgo.user.vehicle-info
  role: persistence_read
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
...
# DELETE /address/delete execution flow
...
- Entry endpoint: `endpoint.ftgo.gateway.delete.address.delete`
- Completeness: `resolved`
- Handler: `application.routes.customer.address.delete_address`
...
- `http_ingress` `step.ftgo.gateway.delete.address.delete.http-ingress`
- `service_dispatch` `step.ftgo.gateway.delete.address.delete.dispatch.services.user.userservice.delete-address`
- `event_publish` `step.ftgo.gateway.delete.address.delete.publish.ftgo.rabbitmq.user.address.delete`
- `event_consume` `step.ftgo.gateway.delete.address.delete.consume.user.user.address.delete`
- `persistence_read` `step.ftgo.gateway.delete.address.delete.read.ftgo.user.customer-address`
- `persistence_read` `step.ftgo.gateway.delete.address.delete.read.ftgo.user.user-profile`
- `persistence_read` `step.ftgo.gateway.delete.address.delete.read.ftgo.user.vehicle-info`
