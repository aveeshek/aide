---
id: flow.ftgo.gateway.post.auth.register
kind: UserFlow
type: UserFlow
title: POST /auth/register execution flow
status: approved
...
entry_endpoint: endpoint.ftgo.gateway.post.auth.register
http_method: POST
path: /auth/register
...
- service.ftgo.user
events:
- event.ftgo.rabbitmq.user.profile.create
persistence_targets:
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.http-ingress
  role: http_ingress
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/gateway/src/application/routes/auth/registration.py
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.read.ftgo.user.customer-address
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.read.ftgo.user.user-profile
  role: persistence_read
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.read.ftgo.user.vehicle-info
  role: persistence_read
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.write.ftgo.user.customer-address
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.write.ftgo.user.user-profile
  role: persistence_write
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.post.auth.register.write.ftgo.user.vehicle-info
  role: persistence_write
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/microservices/user/src/data_access/repository/db_repository.py
...
# POST /auth/register execution flow
...
- Entry endpoint: `endpoint.ftgo.gateway.post.auth.register`
- Completeness: `resolved`
- Handler: `application.routes.auth.registration.register`
...
- `http_ingress` `step.ftgo.gateway.post.auth.register.http-ingress`
- `service_dispatch` `step.ftgo.gateway.post.auth.register.dispatch.services.user.userservice.create-profile`
- `event_publish` `step.ftgo.gateway.post.auth.register.publish.ftgo.rabbitmq.user.profile.create`
- `event_consume` `step.ftgo.gateway.post.auth.register.consume.user.user.profile.create`
- `persistence_read` `step.ftgo.gateway.post.auth.register.read.ftgo.user.customer-address`
- `persistence_read` `step.ftgo.gateway.post.auth.register.read.ftgo.user.user-profile`
- `persistence_read` `step.ftgo.gateway.post.auth.register.read.ftgo.user.vehicle-info`
- `persistence_write` `step.ftgo.gateway.post.auth.register.write.ftgo.user.customer-address`
- `persistence_write` `step.ftgo.gateway.post.auth.register.write.ftgo.user.user-profile`
- `persistence_write` `step.ftgo.gateway.post.auth.register.write.ftgo.user.vehicle-info`
