---
id: schema.ftgo.gateway.application.schemas.restaurant.restaurant.registerrestaurantresponse
kind: Schema
type: Schema
title: RegisterRestaurantResponse
status: approved
...
qualified_name: application.schemas.restaurant.restaurant.RegisterRestaurantResponse
...
- repository: ftgo
  ...
  symbol: application.schemas.restaurant.restaurant.RegisterRestaurantResponse
  line_start: 17
  line_end: 18
  evidence_type: implemented
inbound_relations:
...
- Qualified name: `application.schemas.restaurant.restaurant.RegisterRestaurantResponse`
- Declared in: `backend/gateway/src/application/schemas/restaurant/restaurant.py` (lines 17-18)
