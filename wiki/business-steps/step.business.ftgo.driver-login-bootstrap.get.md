---
id: step.business.ftgo.driver-login-bootstrap.get
kind: FlowStep
type: FlowStep
title: 'Driver login bootstrap: GET /status/get'
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.business.ftgo.driver-login-bootstrap.get-info
  evidence_mechanism:
  - route_navigation
  - lifecycle_hook
  - helper_call
...
# Driver login bootstrap: GET /status/get
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.driver-login-bootstrap` (position 3)
