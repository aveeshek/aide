---
id: step.business.ftgo.restaurant-menu-delete-refresh.get-all-menu-item
kind: FlowStep
type: FlowStep
title: 'Restaurant menu item delete and refresh: POST /menu/get_all_menu_item'
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.business.ftgo.restaurant-menu-delete-refresh.delete
  evidence_mechanism:
  - await_sequence
  - helper_call
  repository: ftgo
...
attributes:
  ...
  inherited_condition_evidence:
  - condition: confirm('آیا از حذف این محصول اطمینان دارید؟')
    kind: confirmation_guard
---

# Restaurant menu item delete and refresh: POST /menu/get_all_menu_item
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.restaurant-menu-delete-refresh` (position 2)
