---
id: step.business.ftgo.restaurant-admin-login-bootstrap.login
kind: FlowStep
type: FlowStep
title: 'Restaurant admin login bootstrap: POST /auth/login'
status: approved
...
# Restaurant admin login bootstrap: POST /auth/login
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.restaurant-admin-login-bootstrap` (position 1)
