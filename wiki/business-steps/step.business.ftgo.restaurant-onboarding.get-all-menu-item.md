---
id: step.business.ftgo.restaurant-onboarding.get-all-menu-item
kind: FlowStep
type: FlowStep
title: 'Restaurant onboarding: POST /menu/get_all_menu_item'
status: approved
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.business.ftgo.restaurant-onboarding.get-supplier-restaurant-info
  evidence_mechanism:
  - route_navigation
  - lifecycle_hook
  - helper_call
...
# Restaurant onboarding: POST /menu/get_all_menu_item
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.restaurant-onboarding` (position 3)
