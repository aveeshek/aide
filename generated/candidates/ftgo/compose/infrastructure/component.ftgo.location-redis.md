---
id: component.ftgo.location-redis
kind: Component
type: Component
title: location_redis
status: candidate
...
extractor: compose
role: infrastructure
compose_service: location_redis
engine: redis
network_aliases:
- location_redis
...
- repository: ftgo
  ...
  pointer: /services/location_redis
  evidence_type: implemented
attributes:
  image: redis:7.2.5
...
- Compose service: `location_redis`
- Declared in: `backend/infra/redis/docker-compose.yaml`
- YAML pointer: `/services/location_redis`
