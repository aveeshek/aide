---
id: column.ftgo.restaurant.menu-item.restaurant-id
kind: Column
type: Column
title: restaurant_id
status: candidate
...
nullable: false
foreign_key: supplier_profile.id
has_default: false
...
- Declared in: `backend/microservices/restaurant/src/models/menu.py` (lines 12-12)
