---
id: column.ftgo.location.driver-location.accuracy
kind: Column
type: Column
title: accuracy
status: candidate
...
- Declared in: `backend/microservices/location/src/data_access/models/driver_location.py` (lines 19-19)
