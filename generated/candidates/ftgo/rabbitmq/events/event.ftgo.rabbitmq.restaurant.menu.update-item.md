---
id: event.ftgo.rabbitmq.restaurant.menu.update-item
kind: Event
type: Event
title: restaurant.menu.update_item
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: restaurant.menu.update_item
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `restaurant.menu.update_item`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.restaurant.menu.update-item`

## Consumers

- `service.ftgo.restaurant` `CONSUMES` -> `event.ftgo.rabbitmq.restaurant.menu.update-item`
