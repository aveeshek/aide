---
id: event.ftgo.rabbitmq.order.rating.update
kind: Event
type: Event
...
- Broker identity: `order.rating.update`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.order.rating.update`

## Consumers

- `service.ftgo.feedback` `CONSUMES` -> `event.ftgo.rabbitmq.order.rating.update`
