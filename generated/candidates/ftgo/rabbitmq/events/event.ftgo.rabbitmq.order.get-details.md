---
id: event.ftgo.rabbitmq.order.get-details
kind: Event
type: Event
title: order.get_details
status: candidate
...
- Broker identity: `order.get_details`
- Correlation: `consumer_only`
- Mechanism: `rpc`
...
- `service.ftgo.order` `CONSUMES` -> `event.ftgo.rabbitmq.order.get-details`
