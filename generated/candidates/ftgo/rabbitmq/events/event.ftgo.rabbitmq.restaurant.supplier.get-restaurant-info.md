---
id: event.ftgo.rabbitmq.restaurant.supplier.get-restaurant-info
kind: Event
type: Event
title: restaurant.supplier.get_restaurant_info
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: restaurant.supplier.get_restaurant_info
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
# restaurant.supplier.get_restaurant_info
...
- Broker identity: `restaurant.supplier.get_restaurant_info`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.restaurant.supplier.get-restaurant-info`

## Consumers

- `service.ftgo.restaurant` `CONSUMES` -> `event.ftgo.rabbitmq.restaurant.supplier.get-restaurant-info`
