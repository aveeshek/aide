---
id: event.ftgo.rabbitmq.restaurant.menu.get-all-menu-item
kind: Event
type: Event
title: restaurant.menu.get_all_menu_item
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: restaurant.menu.get_all_menu_item
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
# restaurant.menu.get_all_menu_item
...
- Broker identity: `restaurant.menu.get_all_menu_item`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.restaurant.menu.get-all-menu-item`

## Consumers

- `service.ftgo.restaurant` `CONSUMES` -> `event.ftgo.rabbitmq.restaurant.menu.get-all-menu-item`
