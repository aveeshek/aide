---
id: event.ftgo.rabbitmq.delivery.rating.get-details
kind: Event
type: Event
title: delivery.rating.get_details
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: delivery.rating.get_details
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `delivery.rating.get_details`
- Correlation: `consumer_only`
- Mechanism: `rpc`
...
- `service.ftgo.feedback` `CONSUMES` -> `event.ftgo.rabbitmq.delivery.rating.get-details`
