---
id: event.ftgo.rabbitmq.restaurant.menu.delete-item
kind: Event
type: Event
title: restaurant.menu.delete_item
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: restaurant.menu.delete_item
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `restaurant.menu.delete_item`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.restaurant.menu.delete-item`

## Consumers

- `service.ftgo.restaurant` `CONSUMES` -> `event.ftgo.rabbitmq.restaurant.menu.delete-item`
