---
id: event.ftgo.rabbitmq.restaurant.menu.add-item
kind: Event
type: Event
title: restaurant.menu.add_item
status: candidate
...
- type: CONSUMES
  ...
  evidence_type: implemented
attributes:
  identity: restaurant.menu.add_item
  mechanism:
  - rpc
  broker_libraries:
  - rabbitmq_rpc
...
- Broker identity: `restaurant.menu.add_item`
- Correlation: `matched`
- Mechanism: `rpc`
...
- `service.ftgo.gateway` `PUBLISHES` -> `event.ftgo.rabbitmq.restaurant.menu.add-item`

## Consumers

- `service.ftgo.restaurant` `CONSUMES` -> `event.ftgo.rabbitmq.restaurant.menu.add-item`
