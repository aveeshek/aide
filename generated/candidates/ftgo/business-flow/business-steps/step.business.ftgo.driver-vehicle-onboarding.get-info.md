---
id: step.business.ftgo.driver-vehicle-onboarding.get-info
kind: FlowStep
type: FlowStep
title: 'Driver vehicle onboarding: GET /vehicle/get_info'
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.business.ftgo.driver-vehicle-onboarding.register
  evidence_mechanism:
  - await_sequence
  - helper_call
  repository: ftgo
...
# Driver vehicle onboarding: GET /vehicle/get_info
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.driver-vehicle-onboarding` (position 2)
- References user flow: `flow.ftgo.gateway.get.vehicle.get-info`
- Trigger: `automatic`
- Evidence mechanism: `await_sequence`, `helper_call`
- Declared in: `ui/src/components/RegisterVehiclePage.vue` (lines 111-115)
