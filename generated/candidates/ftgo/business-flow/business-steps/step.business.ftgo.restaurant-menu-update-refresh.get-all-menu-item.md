---
id: step.business.ftgo.restaurant-menu-update-refresh.get-all-menu-item
kind: FlowStep
type: FlowStep
title: 'Restaurant menu item update and refresh: POST /menu/get_all_menu_item'
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.business.ftgo.restaurant-menu-update-refresh.update
  evidence_mechanism:
  - await_sequence
  - helper_call
  repository: ftgo
...
# Restaurant menu item update and refresh: POST /menu/get_all_menu_item
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.restaurant-menu-update-refresh` (position 2)
