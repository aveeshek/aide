---
id: step.business.ftgo.customer-login-restaurant-browse.login
kind: FlowStep
type: FlowStep
title: 'Customer login and restaurant browsing: POST /auth/login'
status: candidate
...
# Customer login and restaurant browsing: POST /auth/login
...
- Layer: `business`
- Role: `user_flow_reference`
- Business flow: `business-flow.ftgo.ui.customer-login-restaurant-browse` (position 1)
