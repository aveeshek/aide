---
id: step.ftgo.gateway.delete.profile.delete.consume.user.user.profile.delete-account
kind: FlowStep
type: FlowStep
title: user consumes user.profile.delete_account
status: candidate
...
derived_from: event.ftgo.rabbitmq.user.profile.delete-account
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.delete.profile.delete.publish.ftgo.rabbitmq.user.profile.delete-account
...
attributes:
  ...
  handler_expression: ProfileService.delete_account
  handler_symbol: application.profile.ProfileService.delete_account
  operation: register_event
---

# user consumes user.profile.delete_account
...
- Anchored on: `event.ftgo.rabbitmq.user.profile.delete-account` (`Event`)
