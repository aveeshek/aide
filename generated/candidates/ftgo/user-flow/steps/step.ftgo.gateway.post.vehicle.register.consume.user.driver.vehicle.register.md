---
id: step.ftgo.gateway.post.vehicle.register.consume.user.driver.vehicle.register
kind: FlowStep
type: FlowStep
title: user consumes driver.vehicle.register
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.vehicle.register.publish.ftgo.rabbitmq.driver.vehicle.register
...
attributes:
  ...
  handler_expression: VehicleService.register_vehicle
  handler_symbol: application.vehicle.VehicleService.register_vehicle
  operation: register_event
---

# user consumes driver.vehicle.register
