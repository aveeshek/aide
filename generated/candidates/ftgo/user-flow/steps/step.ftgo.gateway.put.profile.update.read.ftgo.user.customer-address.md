---
id: step.ftgo.gateway.put.profile.update.read.ftgo.user.customer-address
kind: FlowStep
type: FlowStep
...
- `application.profile.ProfileService.update_profile` -> `domain.manager.UserManager.load` (`backend/microservices/user/src/application/profile.py:85`)
