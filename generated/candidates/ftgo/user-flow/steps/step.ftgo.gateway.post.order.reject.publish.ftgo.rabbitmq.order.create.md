---
id: step.ftgo.gateway.post.order.reject.publish.ftgo.rabbitmq.order.create
kind: FlowStep
type: FlowStep
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.order.reject.dispatch.services.order.orderservice.create-order
