---
id: step.ftgo.gateway.get.feedback.delivery.rating.customer.publish.ftgo.rabbitmq.delivery.rating.get-customer-ratings
kind: FlowStep
type: FlowStep
title: publish delivery.rating.get_customer_ratings
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.feedback.delivery.rating.customer.dispatch.services.feedback.feedbackservice.get-customer-delivery-ratings
...
# publish delivery.rating.get_customer_ratings
...
- Declared in: `backend/gateway/src/services/feedback.py` (lines 24-24)
