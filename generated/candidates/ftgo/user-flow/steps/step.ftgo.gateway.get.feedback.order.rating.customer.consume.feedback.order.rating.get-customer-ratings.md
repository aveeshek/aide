---
id: step.ftgo.gateway.get.feedback.order.rating.customer.consume.feedback.order.rating.get-customer-ratings
kind: FlowStep
type: FlowStep
title: feedback consumes order.rating.get_customer_ratings
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.feedback.order.rating.customer.publish.ftgo.rabbitmq.order.rating.get-customer-ratings
...
attributes:
  ...
  handler_expression: OrderRatingService.get_customer_order_ratings
  handler_symbol: application.order.OrderRatingService.get_customer_order_ratings
  operation: register_event
---

# feedback consumes order.rating.get_customer_ratings
