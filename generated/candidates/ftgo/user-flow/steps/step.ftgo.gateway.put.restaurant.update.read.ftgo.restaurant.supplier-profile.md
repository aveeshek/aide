---
id: step.ftgo.gateway.put.restaurant.update.read.ftgo.restaurant.supplier-profile
kind: FlowStep
type: FlowStep
...
- repository: ftgo
  ...
  evidence_type: implemented
traces:
- target: domain.restaurant.RestaurantDomain.update_profile_information
  depth: 1
  hops:
  - caller: application.supplier.RestaurantService.update_information
    callee: domain.restaurant.RestaurantDomain.update_profile_information
    call: RestaurantDomain.update_profile_information
    repository: ftgo
    commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
    path: backend/microservices/restaurant/src/application/supplier.py
    symbol: application.supplier.RestaurantService.update_information
    line_start: 100
    line_end: 105
    evidence_type: implemented
relations:
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.put.restaurant.update.consume.restaurant.restaurant.supplier.update-information
...
- Declared in: `backend/microservices/restaurant/src/domain/restaurant.py` (lines 139-143)
- Evidence class: `implemented`

## Call trace

- `application.supplier.RestaurantService.update_information` -> `domain.restaurant.RestaurantDomain.update_profile_information` (`backend/microservices/restaurant/src/application/supplier.py:100`)
