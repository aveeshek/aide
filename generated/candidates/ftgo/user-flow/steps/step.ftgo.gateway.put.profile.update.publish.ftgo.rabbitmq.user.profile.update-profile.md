---
id: step.ftgo.gateway.put.profile.update.publish.ftgo.rabbitmq.user.profile.update-profile
kind: FlowStep
type: FlowStep
title: publish user.profile.update_profile
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.put.profile.update.dispatch.services.user.userservice.update-profile
...
# publish user.profile.update_profile
...
- Declared in: `backend/gateway/src/services/user.py` (lines 47-47)
