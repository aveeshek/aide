---
id: step.ftgo.gateway.post.location.submit.publish.ftgo.rabbitmq.driver.location.submit
kind: FlowStep
type: FlowStep
title: publish driver.location.submit
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.location.submit.dispatch.services.location.locationservice.submit-location
...
# publish driver.location.submit
...
- Declared in: `backend/gateway/src/services/location.py` (lines 11-11)
