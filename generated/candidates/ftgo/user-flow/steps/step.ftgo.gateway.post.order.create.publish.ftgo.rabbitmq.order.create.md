---
id: step.ftgo.gateway.post.order.create.publish.ftgo.rabbitmq.order.create
kind: FlowStep
type: FlowStep
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.post.order.create.dispatch.services.order.orderservice.create-order
