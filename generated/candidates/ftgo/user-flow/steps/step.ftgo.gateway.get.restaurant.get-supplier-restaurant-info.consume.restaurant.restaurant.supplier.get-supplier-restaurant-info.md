---
id: step.ftgo.gateway.get.restaurant.get-supplier-restaurant-info.consume.restaurant.restaurant.supplier.get-supplier-restaurant-info
kind: FlowStep
type: FlowStep
title: restaurant consumes restaurant.supplier.get_supplier_restaurant_info
status: candidate
...
derived_from: event.ftgo.rabbitmq.restaurant.supplier.get-supplier-restaurant-info
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.get.restaurant.get-supplier-restaurant-info.publish.ftgo.rabbitmq.restaurant.supplier.get-supplier-restaurant-info
...
attributes:
  ...
  handler_expression: RestaurantService.get_supplier_restaurant_info
  handler_symbol: application.supplier.RestaurantService.get_supplier_restaurant_info
  operation: register_event
---

# restaurant consumes restaurant.supplier.get_supplier_restaurant_info
...
- Anchored on: `event.ftgo.rabbitmq.restaurant.supplier.get-supplier-restaurant-info` (`Event`)
