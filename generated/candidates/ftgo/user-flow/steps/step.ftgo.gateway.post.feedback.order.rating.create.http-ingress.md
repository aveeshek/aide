---
id: step.ftgo.gateway.post.feedback.order.rating.create.http-ingress
kind: FlowStep
type: FlowStep
title: POST /feedback/order/rating/create ingress
status: candidate
...
# POST /feedback/order/rating/create ingress
