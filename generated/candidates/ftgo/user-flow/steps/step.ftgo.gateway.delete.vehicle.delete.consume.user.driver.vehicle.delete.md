---
id: step.ftgo.gateway.delete.vehicle.delete.consume.user.driver.vehicle.delete
kind: FlowStep
type: FlowStep
title: user consumes driver.vehicle.delete
status: candidate
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: PRECEDES
  source: step.ftgo.gateway.delete.vehicle.delete.publish.ftgo.rabbitmq.driver.vehicle.delete
...
attributes:
  ...
  handler_expression: VehicleService.delete_vehicle
  handler_symbol: application.vehicle.VehicleService.delete_vehicle
  operation: register_event
---

# user consumes driver.vehicle.delete
