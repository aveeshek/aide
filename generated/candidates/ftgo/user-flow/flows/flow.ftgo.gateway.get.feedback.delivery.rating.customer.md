---
id: flow.ftgo.gateway.get.feedback.delivery.rating.customer
kind: UserFlow
type: UserFlow
title: GET /feedback/delivery/rating/customer execution flow
status: candidate
...
entry_endpoint: endpoint.ftgo.gateway.get.feedback.delivery.rating.customer
http_method: GET
...
events:
- event.ftgo.rabbitmq.delivery.rating.get-customer-ratings
persistence_targets:
...
relations:
- type: CONTAINS
  target: step.ftgo.gateway.get.feedback.delivery.rating.customer.consume.feedback.delivery.rating.get-customer-ratings
  role: event_consume
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.get.feedback.delivery.rating.customer.http-ingress
  role: http_ingress
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/gateway/src/application/routes/order/feedback.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.get.feedback.delivery.rating.customer.publish.ftgo.rabbitmq.delivery.rating.get-customer-ratings
  role: event_publish
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
...
# GET /feedback/delivery/rating/customer execution flow
...
- Entry endpoint: `endpoint.ftgo.gateway.get.feedback.delivery.rating.customer`
- Completeness: `resolved`
- Handler: `application.routes.order.feedback.get_customer_delivery_ratings`
...
- `http_ingress` `step.ftgo.gateway.get.feedback.delivery.rating.customer.http-ingress`
- `service_dispatch` `step.ftgo.gateway.get.feedback.delivery.rating.customer.dispatch.services.feedback.feedbackservice.get-customer-delivery-ratings`
- `event_publish` `step.ftgo.gateway.get.feedback.delivery.rating.customer.publish.ftgo.rabbitmq.delivery.rating.get-customer-ratings`
- `event_consume` `step.ftgo.gateway.get.feedback.delivery.rating.customer.consume.feedback.delivery.rating.get-customer-ratings`
- `persistence_read` `step.ftgo.gateway.get.feedback.delivery.rating.customer.read.ftgo.feedback.delivery-ratings`
