---
id: flow.ftgo.gateway.get.address.get-all-info
kind: UserFlow
type: UserFlow
title: GET /address/get_all_info execution flow
status: candidate
...
entry_endpoint: endpoint.ftgo.gateway.get.address.get-all-info
http_method: GET
...
- service.ftgo.user
events:
- event.ftgo.rabbitmq.user.address.get-all-addresses
persistence_targets:
...
- type: CONTAINS
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.get.address.get-all-info.http-ingress
  role: http_ingress
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
  path: backend/gateway/src/application/routes/customer/address.py
  ...
  evidence_type: implemented
- type: CONTAINS
  target: step.ftgo.gateway.get.address.get-all-info.publish.ftgo.rabbitmq.user.address.get-all-addresses
  role: event_publish
  repository: ftgo
  commit: 52b1fd1b5d808e32b7925e890f560445a8460e7a
...
# GET /address/get_all_info execution flow
...
- Entry endpoint: `endpoint.ftgo.gateway.get.address.get-all-info`
- Completeness: `resolved`
- Handler: `application.routes.customer.address.get_all_addresses`
...
- `http_ingress` `step.ftgo.gateway.get.address.get-all-info.http-ingress`
- `service_dispatch` `step.ftgo.gateway.get.address.get-all-info.dispatch.services.user.userservice.get-all-addresses`
- `event_publish` `step.ftgo.gateway.get.address.get-all-info.publish.ftgo.rabbitmq.user.address.get-all-addresses`
- `event_consume` `step.ftgo.gateway.get.address.get-all-info.consume.user.user.address.get-all-addresses`
- `persistence_read` `step.ftgo.gateway.get.address.get-all-info.read.ftgo.user.customer-address`
- `persistence_read` `step.ftgo.gateway.get.address.get-all-info.read.ftgo.user.user-profile`
- `persistence_read` `step.ftgo.gateway.get.address.get-all-info.read.ftgo.user.vehicle-info`
