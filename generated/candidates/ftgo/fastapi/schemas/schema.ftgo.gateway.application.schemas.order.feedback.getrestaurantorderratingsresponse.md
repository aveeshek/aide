---
id: schema.ftgo.gateway.application.schemas.order.feedback.getrestaurantorderratingsresponse
kind: Schema
type: Schema
title: GetRestaurantOrderRatingsResponse
status: candidate
...
qualified_name: application.schemas.order.feedback.GetRestaurantOrderRatingsResponse
...
- repository: ftgo
  ...
  symbol: application.schemas.order.feedback.GetRestaurantOrderRatingsResponse
  line_start: 77
  line_end: 78
  evidence_type: implemented
inbound_relations:
...
# GetRestaurantOrderRatingsResponse

Candidate schema extracted from a class definition in `ftgo` at commit `52b1fd1b5d808e32b7925e890f560445a8460e7a`.

- Qualified name: `application.schemas.order.feedback.GetRestaurantOrderRatingsResponse`
- Declared in: `backend/gateway/src/application/schemas/order/feedback.py` (lines 77-78)
